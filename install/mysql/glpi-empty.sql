...
### Dump table glpi_authmappings

DROP TABLE IF EXISTS `glpi_authmappings`;
CREATE TABLE `glpi_authmappings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `items_id` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `glpi_authsamls` (`id`, `sp_entityid`, `sp_assertionconsumerservice_url`, `sp_assertionconsumerservice_binding`, `sp_singlelogoutservice_url`, `sp_singlelogoutservice_binding`, `sp_nameidformat`, `idp_entityid`, `idp_singlesignonservice_url`) VALUES
(1, 'https://glpi/index.php', 'https://glpi/front/login.php', 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST', 'https://glpi/front/logout.php', 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect', 'urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress', 'http://adfs.test.local/adfs/services/trust', 'https://adfs.test.local/adfs/ls/IdpInitiatedSignon.aspx');
