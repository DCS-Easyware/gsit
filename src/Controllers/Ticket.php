...
final class Ticket extends Common
{
  ...
  public function updateItem(Request $request, Response $response, $args): void
  {
    ...
    {
      $myItem->priority = \App\Controllers\Ticket::computePriority($myItem->urgency, $myItem->impact);
    }
  ...
  public function saveItem($data, $id=null)
  {
    ...
    if (isset($input['itilcategorie']))
    {
      $input['itilcategories_id'] = $input['itilcategorie'];
    }
    ...
    if (isset($updateData['_additional_groups_assigns']))
    {
      ...
      $input['techniciangroup'] = array_filter(array_merge($input['techniciangroup'], $updateData['_additional_groups_assigns']));
    }
