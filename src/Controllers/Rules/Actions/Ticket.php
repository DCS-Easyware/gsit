...
namespace App\Controllers\Rules\Actions;
...
class Ticket
{
  public static function get()
  {
    ...
    return [
      ...
      'users_id_validate' => [
        'name'          => $translator->translate('Send an approval request') . ' - ' . $translator->translatePlural('User', 'Users', 1),
        'type'          => 'dropdown_users_validate',
        'force_actions' => ['add_validation'],
      ],
      'responsible_id_validate' => [
        'name'          => $translator->translate('Send an approval request') . ' - ' . $translator->translate('Responsible of the requester'),
        'type'          => 'yesno',
        'force_actions' => ['add_validation'],
      ],
      'groups_id_validate' => [
        'name'          => $translator->translate('Send an approval request') . ' - ' . $translator->translatePlural('Group', 'Groups', 1),
        'type'          => 'dropdown_groups_validate',
        'force_actions' => ['add_validation'],
      ],
      'validation_percent' => [
        'name'          => $translator->translate('Send an approval request') . ' - ' . $translator->translate('Minimum validation required'),
