...
final class Criteria
{
  ...
  **/
  static function match($criterion, $field, &$criterias_results, &$regex_result)
  {
    ...
    if (($pattern == \App\Controllers\Rules\Common::RULE_WILDCARD)
        || ($condition == \App\Controllers\Rules\Common::PATTERN_FIND))
    {
      return true;
    }
