...
class ItemDeviceMemory
{
  public static function getDefinition()
  {
    ...
    return [
      ...
      [
        'id'    => 11,
        'title' => sprintf($translator->translate('%1$s (%2$s)'), $translator->translate('Size by default'), $translator->translate('Mio')),
        'type'  => 'input',
        'name'  => 'size_default',
      ],
      [
      ...
      [
        ...
        'type'  => 'dropdown_remote',
        'name'  => 'type',
        'dbname' => 'devicememorytypes_id',
        'itemtype' => '\App\Models\ItemDeviceMemoryType',
      ],
      [
        'id'    => 14,
