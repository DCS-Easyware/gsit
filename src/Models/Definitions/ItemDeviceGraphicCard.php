...
class ItemDeviceGraphicCard
{
  public static function getDefinition()
  {
    ...
    return [
      ...
      [
        'id'    => 12,
        'title' => sprintf($translator->translate('%1$s (%2$s)'), $translator->translate('Memory by default'), $translator->translate('Mio')),
        'type'  => 'input',
        'name'  => 'memory_default',
      ],
      [
      ...
      [
        ...
        'type'  => 'dropdown_remote',
        'name'  => 'model',
        'dbname' => 'devicegraphiccardmodels_id',
        'itemtype' => '\App\Models\ItemDeviceGraphicCardModel',
      ],
      [
        'id'    => 16,
