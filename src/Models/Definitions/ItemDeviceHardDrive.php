...
class ItemDeviceHardDrive
{
  public static function getDefinition()
  {
    ...
    return [
      ...
      [
        'id'    => 11,
        'title' => sprintf($translator->translate('%1$s (%2$s)'), $translator->translate('Capacity by default'), $translator->translate('Mio')),
        'type'  => 'input',
      ...
      [
        'id'    => 13,
        'title' => sprintf($translator->translate('%1$s (%2$s)'), $translator->translate('Cache'), $translator->translate('Mio')),
        'type'  => 'input',
        'name'  => 'cache',
      ],
      [
        ...
        'type'  => 'dropdown_remote',
        'name'  => 'model',
        'dbname' => 'deviceharddrivemodels_id',
        'itemtype' => '\App\Models\ItemDeviceHardDriveModel',
      ],
      [
        'id'    => 14,
