  ...
  public static function getDefinition()
  {
    ...
    return [
      ...
      [
        ...
        'type'  => 'dropdown_remote',
        'name'  => 'type',
        'dbname' => 'networkequipmenttypes_id',
      ...
      [
        ...
        'type'  => 'dropdown_remote',
        'name'  => 'model',
        'dbname' => 'networkequipmentmodels_id',
      ...
      [
        'id'    => 14,
        'title' => sprintf($translator->translate('%1$s (%2$s)'),$translator->translatePlural('Memory', 'Memories', 1), $translator->translate('Mio')),
        'type'  => 'input',
        'name'  => 'ram',
      ],
      [
