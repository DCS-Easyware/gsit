...
final class Menu
{
  public static function getMenu(Request $request)
  {
    ...
    $menu = new self();
    $basepath = \App\v1\Controllers\Toolbox::getRootPath($request);
    ...
    return [
      ...
      [
        ...
        'sub'  => [
          ...
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('ITIL category', 'ITIL categories', 2),
            'link' => $basepath . '/dropdowns/categories',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/categories' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Task category', 'Task categories', 2),
          ...
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Task template', 'Task templates', 2),
          ...
          [
            ...
            'link' => $basepath . '/dropdowns/devicegenerictype',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicegenerictype' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Sensor type', 'Sensor types', 2),
            'link' => $basepath . '/dropdowns/devicesensortype',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicesensortype' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Memory type', 'Memory types', 2),
            'link' => $basepath . '/dropdowns/devicememorytype',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicememorytype' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
          ...
          [
            ...
            'link' => $basepath . '/dropdowns/devicecasetype',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicecasetype' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
          ...
          [
            ...
            'link' => $basepath . '/dropdowns/devicecasemodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicecasemodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device control model', 'Device control models', 2),
            'link' => $basepath . '/dropdowns/devicecontrolmodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicecontrolmodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device drive model', 'Device drive models', 2),
            'link' => $basepath . '/dropdowns/devicedrivemodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicedrivemodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device generic model', 'Device generic models', 2),
            'link' => $basepath . '/dropdowns/devicegenericmodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicegenericmodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device graphic card model', 'Device graphic card models', 2),
            'link' => $basepath . '/dropdowns/devicegraphiccardmodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicegraphiccardmodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device hard drive model', 'Device hard drive models', 2),
            'link' => $basepath . '/dropdowns/deviceharddrivemodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/deviceharddrivemodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device memory model', 'Device memory models', 2),
            'link' => $basepath . '/dropdowns/devicememorymodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicememorymodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('System board model', 'System board models', 2),
            'link' => $basepath . '/dropdowns/devicemotherboardmodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicemotherboardmodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Network card model', 'Network card models', 2),
            'link' => $basepath . '/dropdowns/devicenetworkcardmodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicenetworkcardmodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Other component model', 'Other component models', 2),
            'link' => $basepath . '/dropdowns/devicepcimodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicepcimodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device power supply model', 'Device power supply models', 2),
            'link' => $basepath . '/dropdowns/devicepowersupplymodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicepowersupplymodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device processor model', 'Device processor models', 2),
            'link' => $basepath . '/dropdowns/deviceprocessormodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/deviceprocessormodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device sound card model', 'Device sound card models', 2),
            'link' => $basepath . '/dropdowns/devicesoundcardmodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicesoundcardmodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Device sensor model', 'Device sensor models', 2),
            'link' => $basepath . '/dropdowns/devicesensormodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/dropdowns/devicesensormodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
          ...
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Knowledge base category', 'Knowledge base categories', 2),
          ...
          [
            'name' => $translator->translatePlural('Dropdown', 'Dropdowns', 2) . ' - ' .
                      $translator->translatePlural('Oauth IMAP application', 'Oauth IMAP applications', 2),
          ...
          [
            ...
            'link' => $basepath . '/devices/devicepowersupplies',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicepowersupplies' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Battery', 'Batteries', 2),
            'link' => $basepath . '/devices/devicebatteries',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicebatteries' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Case', 'Cases', 2),
            'link' => $basepath . '/devices/devicecases',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicecases' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Sensor', 'Sensors', 2),
            'link' => $basepath . '/devices/devicesensors',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicesensors' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Simcard', 'Simcards', 2),
            'link' => $basepath . '/devices/devicesimcards',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicesimcards' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Graphics card', 'Graphics cards', 2),
            'link' => $basepath . '/devices/devicegraphiccards',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicegraphiccards' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('System board', 'System boards', 2),
            'link' => $basepath . '/devices/devicemotherboards',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicemotherboards' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Network card', 'Network cards', 2),
            'link' => $basepath . '/devices/devicenetworkcards',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicenetworkcards' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Soundcard', 'Soundcards', 2),
            'link' => $basepath . '/devices/devicesoundcardmodels',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicesoundcardmodels' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Generic device', 'Generic devices', 2),
            'link' => $basepath . '/devices/devicegenerics',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicegenerics' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Controller', 'Controllers', 2),
            'link' => $basepath . '/devices/devicecontrols',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicecontrols' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Hard drive', 'Hard drives', 2),
            'link' => $basepath . '/devices/deviceharddrives',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/deviceharddrives' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Firmware', 'Firmware', 2),
            'link' => $basepath . '/devices/devicefirmwares',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicefirmwares' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Drive', 'Drives', 2),
            'link' => $basepath . '/devices/devicedrives',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicedrives' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Memory', 'Memory', 2),
            'link' => $basepath . '/devices/devicememories',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicememories' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('Processor', 'Processors', 2),
            'link' => $basepath . '/devices/deviceprocessors',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/deviceprocessors' ? 'active' : '',
          ],
          [
            'name' => $translator->translatePlural('Component', 'Components', 2) . ' - ' .
                      $translator->translatePlural('PCI device', 'PCI devices', 2),
            'link' => $basepath . '/devices/devicepcis',
            'icon' => 'edit',
            'class' => $activePath == $basepath . '/devices/devicepcis' ? 'active' : '',
          ],
          [
