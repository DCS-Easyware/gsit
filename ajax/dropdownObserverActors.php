<?php
/*
 * @version $Id: dropdownObserverActors.php 22657 2014-02-12 16:17:54Z moyo $
 -------------------------------------------------------------------------
   ...
   if ($item = getItemForItemtype($_POST["itemtype"])) {
      switch ($_POST["type"]) {
         case "user" :
            ...
            $options = array('name'        => '_itil_'.$_POST["actortype"].'[users_id]['.$_POST['r'].']',
         ...
         case "group" :
            ...
            $cond  = (($_POST["actortype"] == 'assign') ? $cond = '`is_assign`'
                                                        : $cond = '`is_requester`');
            $param = array('name'      => '_itil_'.$_POST["actortype"].'[groups_id]['.$_POST['r'].']',
                           'entity'    => $_POST['entity_restrict'],
                           'condition' => $cond,
                           'rand'      => $rand);
            if (($_POST["itemtype"] == 'Ticket')
