...
/// Class Entity_SLA
/// since version 0.86
class Entity_SLA extends CommonDBRelation {
   ...
   /**
    * Get entities for a SLA
    *
    * @param $slas_id ID of the SLA
    *
    * @return array of entities linked to a SLA
   **/
   static function getEntities($slas_id) {
      global $DB;

      $ent   = array();
      $query = "SELECT `glpi_entities_slas`.*
                FROM `glpi_entities_slas`
