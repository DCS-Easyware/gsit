...
/// Class Group_Sla
/// since version 0.86
class Group_SLA extends CommonDBRelation {
   ...
   /**
    * Get groups for a SLA
    *
    * @param $slas_id ID of the SLA
    *
    * @return array of groups linked to a SLA
   **/
   static function getGroups($slas_id) {
      global $DB;

      $groups = array();
      $query  = "SELECT `glpi_groups_slas`.*
                 FROM `glpi_groups_slas`
