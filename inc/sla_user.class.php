...
/// Class SLA_User
/// since version 0.86
class SLA_User extends CommonDBRelation {
    ...
    *
    * @return array of users linked to a SLA
   **/
   static function getUsers($slas_id) {
      global $DB;

      $users = array();
      $query = "SELECT `glpi_slas_users`.*
                FROM `glpi_slas_users`
