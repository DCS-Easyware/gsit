...
class RuleItilFollowupCollection extends RuleCollection {

   // From RuleCollection
   static $rightname                             = 'rule_ticket';
   public $use_output_rule_process_as_next_input = true;
   public $menu_option                           = 'itilfollowup';
   ...
   **/
   ...
   static function canView() {
      return Session::haveRightsOr(self::$rightname, [READ, RuleItilFollowup::PARENT]);
   }
   ...
   **/
   function showInheritedTab() {
      return (Session::haveRight(self::$rightname, RuleItilFollowup::PARENT) && ($this->entity));
   }
